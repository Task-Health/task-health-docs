...
| CLINICAL_DOCUMENTS.md | ✅ Substantial | ~1,300 lines. Full PatientDocumentContentItem interface (~60 fields), 30 question types, adapter pipeline, 5 answer mapping types, 11-area change chain, 3 PDF pipelines, CMS-485 cross-doc mapping, mobile API endpoint |
